...
| Metadata Field | Filename Code ([Table 3.2](part3-filenames.qmd#tbl-3-2)) |  Status   | Field Description          | Data Type |
|-----------------------------|--------|--------|--------|----------|--------------------------------------------------------------------------------------------------------------------|-----------|
| `backgroundClass`             | `BG` | Required | EEnumerated abbreviated code from Background Class Codes Table 4.7 describing the type of background used behind target tissue. Both abbreviated codes and descriptive codes are accepted. Examples: `BGW`, `BGB`, `BGP`. | ENUM [Table 4.7](#tbl-4-7) |
...
| `tissueDevelopmentalStage`    | - | Required | Tissue developmental stage as coded in Developmental Stage Class Codes [Table 4.4](#tbl-4-4). Examples: `Mature`, `Uncertain`.         | ENUM [Table 4.4](#tbl-4-4) |
...
- See example of data and metadata sharing here: [https://doi.org/10.7910/DVN/LXPHBC](https://doi.org/10.7910/DVN/LXPHBC)
